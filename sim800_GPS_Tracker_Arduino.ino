...
const String FIREBASE_HOST  = "put your firebase host here";
const String FIREBASE_SECRET  = "put your database secret here";
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//Function: get gps co-ordinate() start
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
String get_gps()
{
  ...
  //if (!gps.location.isUpdated()) {
    //Serial.print("GPS data not found ")
     // goto label;
  //}
